  ...
  async function removeFavorite(props){
    ...
    console.log("removed favorite");
       ...
       var myHeaders1 = new Headers();
        ...
        const datavalue = await fetch("http://localhost:8085/favoriteproduct/deletefavoriteproduct/"+userEmail+"/"+props,requestOptions1)
        fetchData();
      }
    ...
    async function fetchData() {
      ...
      const datavalue = await fetch("http://localhost:8085/favoriteproduct/getfavouriteproduct/"+userEmail,requestOptions1)
