...
function ImageGallery() {
  ...
  const addFavorite = async (props) => {
   ...
   var myHeaders1 = new Headers();
    ...
    const datavalue = await fetch("http://localhost:8085/favoriteproduct/savefavouriteproduct",requestOptions1)
  ...
  const handleClick = async () => {
   ...
   var myHeaders1 = new Headers();
    ...
    const datavalue = await fetch("http://localhost:8085/product/productname/"+queryString,requestOptions1)
